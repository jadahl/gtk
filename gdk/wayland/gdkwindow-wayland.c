                     ...
                     int32_t               height)
{
  ...
  calculate_popup_rect (window,
                        impl->pending_move_to_rect.anchor_rect,
                           ...
                           GdkWindow *parent)
{
  ...
  real_anchor_rect_x = impl->pending_move_to_rect.anchor_rect.x;
  real_anchor_rect_y = impl->pending_move_to_rect.anchor_rect.y;
  parent = get_real_parent_and_translate (window,
                                          impl->transient_for,
                                          &real_anchor_rect_x,
                                          &real_anchor_rect_y);

  anchor_rect_width = impl->pending_move_to_rect.anchor_rect.width;
  anchor_rect_height = impl->pending_move_to_rect.anchor_rect.height;
                                 ...
                                 gint                rect_anchor_dy)
{
  ...
  impl->pending_move_to_rect.anchor_rect = *rect;
